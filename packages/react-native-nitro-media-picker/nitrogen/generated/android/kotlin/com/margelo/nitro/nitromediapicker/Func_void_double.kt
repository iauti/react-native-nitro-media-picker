...
/**
 * Represents the JavaScript callback `(fraction: number) => void`.
...
fun interface Func_void_double: (Double) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(fraction: Double): Unit
}
...
class Func_void_double_cxx: Func_void_double {
  ...
  private external fun invoke_cxx(fraction: Double): Unit
}
